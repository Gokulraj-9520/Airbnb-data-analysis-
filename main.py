...
with tab1:
    ...
    if country_in and city_in and min_price and max_price:
        try:
            ...
            st.subheader(':orange[Top Hotels Recommendations] 🏰')
            ...
            st.subheader(':orange[Top Hotels by Price and Ratings] 💸')

            query_top = data.query(f'country == "{country_in}" and city == "{city_in}"')
            ...
            st.subheader(':orange[Enter the ID to know more about the Hotel and Availability] 📶')
